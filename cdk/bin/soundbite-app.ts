...
const databaseStack = new DatabaseStack(
  app,
  `${stackConfig.projectName}-${environmentConfig.prefix}-Database`,
  {
    ...stackConfig,
...
const storageStack = new StorageStack(
  app,
  `${stackConfig.projectName}-${environmentConfig.prefix}-Storage`,
  {
    ...stackConfig,
...
const computeStack = new ComputeStack(
  app,
  `${stackConfig.projectName}-${environmentConfig.prefix}-Compute`,
  {
    ...stackConfig,
...
const apiStack = new ApiStack(
  app,
  `${stackConfig.projectName}-${environmentConfig.prefix}-API`,
  {
    ...stackConfig,
