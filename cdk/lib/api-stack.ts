  ...
  constructor(scope: Construct, id: string, props: ApiStackProps) {
    ...
    if (props.enableMultiEnvironment ?? false) {
      ...
      userData.addCommands(
        ...
        'docker stop soundbite-dev-localstack soundbite-dev-aws soundbite-dev-aws-deployed soundbite-staging soundbite-production soundbite-nginx localstack || true',
        'docker rm soundbite-dev-localstack soundbite-dev-aws soundbite-dev-aws-deployed soundbite-staging soundbite-production soundbite-nginx localstack || true',
        ...
        // Host nginx config removed — nginx is managed by Docker Compose
        '',
